...
article = '''키움 히어로즈가 한화 이글스와의 3연전을 쓸어 담고 7연승을 내달렸다.
...
# 입력 텍스트 분할
max_length = 510
chunks = split_text(article, tokenizer, max_length)

entities = []
for chunk in chunks:
    entities.extend(ner_model(chunk))

# 중요한 정보 추출 및 정리
key_info = {}
for entity in entities:
    key_info[entity['word']] = entity['entity_group']

print("추출된 정보:", key_info)
